...
<head>
    ...
    <title>Business News - BaliwtaPH</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="category-header">
        <div class="container text-center">
            ...
            <h1 class="display-4 fw-bold">Business</h1>
            <p class="lead mb-0">Latest updates on economy, finance, markets, and corporate news in the Philippines</p>
        </div>
    </div>
